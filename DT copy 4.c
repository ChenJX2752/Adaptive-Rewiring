...
void handleSimplexRewiring(SimplexList *simplexList, Network *network, int *state)
{
    ...
    // if (simplexList->numSimplices < 4261)
    // {
    //     int count_ls=0;
    //     while (1)
    //     {
    ...
    //                 if (count_ls == 2000 || simplexList->numSimplices==4261)
    //                 {
    //                     break;
    //                 }
    //             }
    ...
    // {
    //     for (int j = i + 1; j < MAX_NODES - 1; j++)
    //     {
    //         for (int k = j + 1; k < MAX_NODES; k++)
    //         {
    //             if (1)
    //             {
    //                 if (isConnected(network->adjacencyList, i, j) &&
    //                     isConnected(network->adjacencyList, i, k) &&
    //                     isConnected(network->adjacencyList, j, k) &&
    //                     !isInSimplex(simplexList->simplices, i, j, k))
    //                 {
    //                     if (simplex_deleted != 0)
    //                     {
    //                         u = i;
    ...
    // printf("%d %d %d\n", simplex_deleted, ss, simplexList->numSimplices);
}
